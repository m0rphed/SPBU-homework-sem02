namespace ProblemSet06.Task01.Tests
{
    ...
    {
        [Test]
        public void IsPositiveElements()
        {
        ...
        [Test]
        public void AbsoluteValueMoreThanHundred()
        {
        ...
        [Test]
        public void OnlyUpperCaseLetters()
        {
            var sut = new List<string>() { "KITTEN", "A BUG", "wale", "Computer Science", string.Empty };
            bool IsUpperCase(string v) => string.IsNullOrEmpty(v) || v.ToUpper() == v;
